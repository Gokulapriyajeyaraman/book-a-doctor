  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap flex-col pb-5 place-self-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 ">
          ...
          <div  className = 'w-100 h-40 bg-cover'style={{ backgroundImage: `url(./public/images/doc.jpg)` }}></div>
          <h1 className='mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white'>Book Appointment</h1>
          <p className='mb-3 font-normal text-gray-700 dark:text-gray-400'> For  the hospital & clinical admissions.</p>
        ...
        <div className="flex flex-wrap flex-col pb-5 place-self-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 ">
          ...
          <div  className = 'w-100 h-40 bg-cover'style={{ backgroundImage: `url(./public/images/med.jpg)` }}></div>
